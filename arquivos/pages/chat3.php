...
<div id="chat">
	...
	<section class="container-page">
		<section class="container-chats">
			...
			<ul>
				...
				<li><a href="chat3.php"><button style="background-color: #696969; padding-top: 15px;
    padding-bottom: 15px;"><span><img class="icon-invert" src="../imgs/hashtag.png"></span> &nbsp; Geral</button></a></li>
				<li><a href="chat4.php"><button><span><img class="icon-invert" src="../imgs/hashtag.png"></span> &nbsp; Conversa 1</button></a></li>
	...
	<?php
        	...
        	$sql_code = 'SELECT * FROM chat3 WHERE id_mensagem ORDER BY id_mensagem ASC;';
		...
		if (isset($_POST['enviar'])) {
		   ...
		   $sqlacc = "SELECT * FROM contas INNER JOIN fotos ON contas.id = fotos.id_fotos Where id= ". $_SESSION['id'] .";";
			...
			// 	 echo ('<script>window.alert("Somente admnstradores podem enviar mensagens nesse chat!");window.location="chat2.php#page-end";</script>');
			// }else{

			$sqlcad = 'insert into chat3(mensagem, chat, fk_id, fk_nome_fotos, fk_nickname) values ("'.$mensagens.'", "chat 2", "'.$id_user.'", "'.$nome_fotos.'","'.$nickname.'");';
