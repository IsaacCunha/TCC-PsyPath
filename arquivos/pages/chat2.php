...
<div id="chat">
	...
	<section class="container-page">
		<section class="container-chats">
			...
			<ul>
				...
				<li><a href="chat2.php"><button  style="background-color: #696969; padding-top: 15px;
    padding-bottom: 15px;"><span><img class="icon-invert" src="../imgs/fone.png"></span> &nbsp; Comunicados</button></a></li>
	...
	<?php
        	...
        	$sql_code = 'SELECT * FROM chat2 WHERE id_mensagem ORDER BY id_mensagem ASC;';
		...
		if (isset($_POST['enviar'])) {
			...
			if($_SESSION['nivel_acesso'] < 1){
			 	 echo ('<script>window.alert("Somente psicólogos podem enviar mensagens nesse chat!");window.location="chat1.php#page-end";</script>');
			 }else{
			...
			$sqlcad = 'insert into chat2(mensagem, chat, fk_id, fk_nome_fotos, fk_nickname) values ("'.$mensagens.'", "chat 1", "'.$id_user.'", "'.$nome_fotos.'","'.$nickname.'");';
