    ...
    <section class="container-login100">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" name="cadastro" class="login100-form validate-form" >
            ...
            <section style="padding-bottom: 50px;">
                ...
                <a href="Cadastro_psicologo.php"    id="psicologo" id="selecionado"><span id="selecionado">Psicologo</span></a>
            </section>
            <?php 
            ...
            echo '<input class="input100" type="text" name="nome" required="" placeholder="Nos conte seu nome" value="'.$_SESSION["nome"].'" />';
            }else {
            echo '<input class="input100" placeholder="Nos conte seu nome" type="text" name="nome" value="" />';
            }

            echo '<span class="focus-input100" data-symbol="&#xf206;"></span>
            </section>
            <section class="wrap-input100 validate-input paddingb" data-validate = "Apelido é necessario">
            <span class="label-input100">Apelido</span>';

            if (isset($_SESSION["nickname"])){
            echo '<input class="input100"  type="text" name="nickname" placeholder="Como quer ser chamado?" required="" value="'.$_SESSION["nickname"].'" />';
            } else {
            echo '<input class="input100"  type="text" name="nickname" placeholder="Como quer ser chamado?" value="" />';
            }
            ...
            echo '<input class="input100" placeholder="Qual é o seu Email?"  type="email" name="email" required="" value="'.$_SESSION["email"].'" />';
            } else {
            echo '<input class="input100"  placeholder="Qual é o seu Email?" type="email" name="email" value="" />';
            }
?>
            ...
            <section class="wrap-input100 validate-input paddingb" data-validate = "Email é necessario">
                <span class="label-input100">Senha</span>
                    <input class="input100" placeholder="Digite uma senha forte"  type="password" name="senha" required="" />
                <span class="focus-input100" data-symbol="&#xf190;"></span>
            </section>
...
<?php
            ...
            echo '<input class="input100"  type="text" name="descricao" placeholder="Nos conte um pouco sobre você..." required="" value="'.$_SESSION["descricao"].'" />';
            } else {
            echo '<input class="input100"  type="text" name="descricao" placeholder="Nos conte um pouco sobre você..." value="" />';
            }
            ?>
                <span class="focus-input100" data-symbol="&#xf1d6;"></span>
            </section>
            ...
            <section class="wrap-input100 validate-input paddingb" data-validate = "CPF é necessario">
                <span class="label-input100">CPF</span>
                    <input class="input100"  type="text"  minlength="14" maxlength="14" name="cpf" onkeypress="formatar_mascara(this,'###.###.###-##')" placeholder="Digite seu CPF" required="" />
                <span class="focus-input100" data-symbol="&#xf10d;"></span>
            </section>
            
            <section class="wrap-input100 validate-input paddingb" data-validate = "CEP é necessario">
                <span class="label-input100">CEP</span>
                    <input class="input100"  type="text"  minlength="9" maxlength="9" name="cep" onkeypress="formatar_mascara(this,'#####-###')" required="" placeholder="Digite seu CEP" />
                <span class="focus-input100" data-symbol="&#xf1e6;"></span>
            </section>

            <section class="wrap-input100 validate-input paddingb" data-validate = "Universidade é necessario">
                <span class="label-input100">Universidade</span>
                    <?php
                    if (isset($_SESSION["universidade"])){
                    echo '<input class="input100"  type="text"      name="universidade" placeholder="Você é de qual universidade?" required="" value="'.$_SESSION      ["universidade"].'" />';
                    } else {
                    echo '<input class="input100"  type="text"      name="universidade" placeholder="Você é de qual universidade?"  value="" />';
                    }
           	        ?>
                <span class="focus-input100" data-symbol="&#xf175;"></span>
            </section>

            <section class="wrap-input100 validate-input paddingb" data-validate = "Semestre é necessario">
                <span class="label-input100">Semestre</span>
                    <input class="input100"  type="text" placeholder="aaaa/mm/dd" minlength="10" maxlength="10" name="semestre" onkeypress="formatar_mascara(this,'####-##-##')" required="" />
                <span class="focus-input100" data-symbol="&#xf332;"></span>
            </section>
...
<?php
        ...
        if(isset($_POST['Cadastrar'])){
            ...
            $dir = "..\imagens/";
            $foto = $_FILES['foto']; // Exemplo: img.jpg
        ...
        // Verifica se o tamanho da imagem é maior que o tamanho permitido
            ...
            echo ('<script>window.alert("CEP só deve conter números");window.location="cadastro_estudante.php";</script>');
        }else{
        ...
        // Se não houver nenhum erro
                        if ($dimensoes[0] <= $largura && $dimensoes[1] <= $altura && $foto["size"] <= $tamanho){
                            ...
                            $sqlcad = 'insert into contas(nome, nickname, email, senha, descricao, cpf, cep, universidade, semestre, crm, nivel_acesso, banimento) values ("'.$nome.'", "'.$nickname.'", "'.$email.'", "'.$senha.'", "'.$descricao.'", "'.$cpf.'", "'.$cep.'", "'.$universidade.'", "'.$semestre.'", "'.$crm.'", 1, 0);';
                            ...
                            $sql_pdf = 'INSERT INTO laudos(nome_laudos, data) VALUES ("pdf_inválido_psicologo", "2022-11-27 23:21:32");';
