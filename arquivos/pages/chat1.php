...
<div id="chat">
	...
	<section class="container-page">
		<section class="container-chats">
			...
			<ul>
				<li><button style="background-color: #696969; padding-top: 15px;
    padding-bottom: 15px;"><span><img class="icon-invert" src="../imgs/regras.png"></span> &nbsp; Regras</button></li>
	...
	<?php
        	...
        	$sql_code = 'SELECT * FROM chat1 WHERE id_mensagem ORDER BY id_mensagem ASC;';
		...
		if (isset($_POST['enviar'])) {
		   ...
		   $sqlacc = "SELECT * FROM contas INNER JOIN fotos ON contas.id = fotos.id_fotos Where id= ". $_SESSION['id'] .";";
			...
			$sqlcad = 'insert into chat1(mensagem, chat, fk_id, fk_nome_fotos, fk_nickname) values ("'.$mensagens.'", "chat 1", "'.$id_user.'", "'.$nome_fotos.'","'.$nickname.'");';
